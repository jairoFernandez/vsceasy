...
<CardGrid stagger>
  ...
  <Card title="Editor surface" icon="pencil">
  ...
  <Card title="LLM built in" icon="star">
  ...
  <Card title="Not just webviews" icon="seti:config">
  ...
  <Card title="Built with vsceasy" icon="rocket">
